...
import com.lzhs.library.wedgit.comm_adapter.abslistview.base.ItemViewDelegateManager;
...
public class MultiItemTypeAdapter<T> extends BaseAdapter {
    ...
    protected void convert(ViewHolder mHolder, T item, int position) {
        mItemViewDelegateManager.convert(mHolder, item, position);
    }
