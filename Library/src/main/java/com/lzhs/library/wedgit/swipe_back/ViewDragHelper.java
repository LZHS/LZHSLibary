...
package com.lzhs.library.wedgit.swipe_back;
...
public class ViewDragHelper {
     ...
     * callback's
     * {@link com.lzhs.lzhs_library.wedgit.swipe_back.ViewDragHelper.Callback#onEdgeTouched(int, int)}
     * and
     * {@link com.lzhs.lzhs_library.wedgit.swipe_back.ViewDragHelper.Callback#onEdgeDragStarted(int, int)}
     ...
     * {@link com.lzhs.lzhs_library.wedgit.swipe_back.ViewDragHelper.Callback#tryCaptureView(View, int)}
     ...
     * {@link com.lzhs.lzhs_library.wedgit.swipe_back.ViewDragHelper.Callback#getOrderedChildIndex(int)}
     * .
     *
     * @param x X position to test in the parent's coordinate system
     * @param y Y position to test in the parent's coordinate system
