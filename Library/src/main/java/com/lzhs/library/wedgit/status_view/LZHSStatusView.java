package com.lzhs.library.wedgit.status_view;
 ...
 */
public class LZHSStatusView extends FrameLayout {
    ...
    public LZHSStatusView(@NonNull Context context) {
        this(context, null, R.attr.StatusViewAttr);
    }

    public LZHSStatusView(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, R.attr.StatusViewAttr);
    }

    public LZHSStatusView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void initAttr(AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray mTypeArr = mContext.obtainStyledAttributes(attrs, R.styleable.LZHSStatusView, defStyleAttr, R.style.LZHSStatusView);
        mConfig.mStatusEmptyImage = mTypeArr.getResourceId(R.styleable.LZHSStatusView_StatusEmptyImage, mConfig.mStatusEmptyImage);
        mConfig.mStatusEmptyText = mTypeArr.getString(R.styleable.LZHSStatusView_StatusEmptyText);

        mConfig.mStatusErrorImage = mTypeArr.getResourceId(R.styleable.LZHSStatusView_StatusErrorImage, mConfig.mStatusErrorImage);
        mConfig.mStatusErrorText = mTypeArr.getString(R.styleable.LZHSStatusView_StatusErrorText);
        mConfig.mStatusRetryText = mTypeArr.getString(R.styleable.LZHSStatusView_StatusRetryText);

        mConfig.mStatusTextColor = mTypeArr.getColor(R.styleable.LZHSStatusView_StatusTextColor, mConfig.mStatusTextColor);
        mConfig.mStatusTextSize = mTypeArr.getDimensionPixelSize(R.styleable.LZHSStatusView_StatusTextSize, mConfig.mStatusTextSize);

        mConfig.mStatusButtonTextColor = mTypeArr.getColor(R.styleable.LZHSStatusView_StatusButtonTextColor, mConfig.mStatusButtonTextColor);
        mConfig.mStatusButtonTextSize = mTypeArr.getDimensionPixelSize(R.styleable.LZHSStatusView_StatusButtonTextSize, mConfig.mStatusButtonTextSize);
        mConfig.mStatusButtonBackground = mTypeArr.getDrawable(R.styleable.LZHSStatusView_StatusButtonBackground);

        mConfig.mStatusLoadingText = mTypeArr.getString(R.styleable.LZHSStatusView_StatusLoadingText);

        mConfig.mStatusEmptyResId = mTypeArr.getResourceId(R.styleable.LZHSStatusView_StatusEmptyResId, mConfig.mStatusEmptyResId);
        mConfig.mStatusErrorResId = mTypeArr.getResourceId(R.styleable.LZHSStatusView_StatusErrorResId, mConfig.mStatusErrorResId);
        mConfig.mStatusLoadingResId = mTypeArr.getResourceId(R.styleable.LZHSStatusView_StatusLoadingResId, mConfig.mStatusLoadingResId);
        mTypeArr.recycle();
    }

    public static LZHSStatusView wrap_v4(android.support.v4.app.Fragment mFragment) {
        return wrap(mFragment.getView());
    }

    public static LZHSStatusView wrap(Fragment mFragment) {
        return wrap(mFragment.getView());
    }

    public static LZHSStatusView wrap(Activity mActivity) {
        return wrap(((ViewGroup) mActivity.findViewById(android.R.id.content)).getChildAt(0));
    }

    public static LZHSStatusView wrap(View mView) {
        if (mView == null) throw new RuntimeException("LZHSStatusView 将要包裹的Vie不能为空");
        ViewGroup mParent = (ViewGroup) mView.getParent();
        if (mParent == null) throw new RuntimeException("LZHSStatusView 将要依附的父控件不能为空");
        ViewGroup.LayoutParams mLayoutPara = mView.getLayoutParams();
        int index = mParent.indexOfChild(mView);
        mParent.removeView(mView);
        LZHSStatusView mStatusView = new LZHSStatusView(mView.getContext());
     ...
     * @return
     */
    public LZHSStatusView setLoading(@LayoutRes int id) {
     ...
     * @return
     */
    public LZHSStatusView setEmpty(@LayoutRes int id) {
     ...
     * @return
     */
    public LZHSStatusView setError(@LayoutRes int id) {
     ...
     */
    public LZHSStatusView setRetryListenet(OnClickListener mRetryListenet) {
     ...
     */
    public LZHSStatusView setEmptyListenet(OnClickListener mEmptyListenet) {
     ...
     * @return
     */
    public LZHSStatusView setEmptyImage(@DrawableRes int resId) {
     ...
     * @return
     */
    public LZHSStatusView setEmptyText(String value) {
     ...
     * @return
     */
    public LZHSStatusView setErrorImage(@DrawableRes int resId) {
     ...
     * @return
     */
    public LZHSStatusView setErrorText(String value) {
        mConfig.mStatusErrorText = value;
        return this;
    }
     ...
     * @return
     */
    public LZHSStatusView setRetryText(String text) {
     ...
     * @return
     */
    public LZHSStatusView setLoadingText(String text) {
    ...
    class Config {
        ...
        OnClickListener mRetryListenet = null;

        OnClickListener mEmptyListenet = null;
